...
export default function ContactPage() {
    const t = useTranslations('Navigation'); // Or specific Contact translations

    return (
        <div className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                    <h1 className="font-serif text-4xl text-[color:var(--accent-gold)] mb-6">Contact</h1>
                    <p className="text-slate-300 mb-8 font-light">
                        Pour toute demande de création, de restauration ou pour visiter l&apos;atelier,
                        n&apos;hésitez pas à me contacter.
                    </p>

                    <div className="space-y-6">
                        <div>
                            <h3 className="text-sm uppercase tracking-widest text-slate-500 mb-1">Atelier</h3>
                            <p className="text-white">12 Rue de l&apos;Artisanat<br />75000 Paris</p>
                        </div>
                        <div>
                            <h3 className="text-sm uppercase tracking-widest text-slate-500 mb-1">Email</h3>
                            <a href="mailto:contact@arnaultjanvier.com" className="text-[color:var(--accent-gold)] hover:underline">
                                contact@arnaultjanvier.com
                            </a>
                        </div>
                        <div>
                            <h3 className="text-sm uppercase tracking-widest text-slate-500 mb-1">Téléphone</h3>
                ...
                <div className="bg-slate-900/50 p-8 rounded-lg border border-white/5">
                    <form className="space-y-6">
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium text-slate-400 mb-2">Nom & Prénom</label>
